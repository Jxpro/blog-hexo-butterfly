---
title: MinIO Client 安装和配置
description:  MinIO 客户端 mc 命令行工具用于管理 MinIO 服务端，支持文件系统和兼容 Amazon S3 的云存储服务。可以通过二进制文件安装，也可以通过 Docker 使用，但是 Docker 测试无效。
date: 2024/02/01 22:29:13
updated: 2024/02/01 23:09:03
categories:
  - Tool
  - MinIO
tags:
