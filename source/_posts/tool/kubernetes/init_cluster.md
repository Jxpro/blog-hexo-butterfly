---
title: Ubuntu 搭建 k8s 集群 ( 公网，详细讲解版 )
description: 记录公网环境下使用 Ubuntu 搭建 k8s 集群的详细过程，包括系统设置、软件安装、Master 配置、Worker 添加等步骤。通过虚拟网卡绑定公网 IP，解决 kubeadm 初始化和加入集群的问题，但是网络插件无法正常工作。
date: 2024/06/27 16:47:23
