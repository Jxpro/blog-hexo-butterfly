---
title: Fabric 案例 - Fabcar
description: 通过 Fabcar 案例介绍 Fabric 开发的基础知识，学习如何运行 fabcar 网络，接着学习登记用户、查询账本、更新账本等。
date: 2021/11/07 16:35:43
updated: 2022/03/26 13:02:33
permalink: blockchain/fabric/demo_fabcar/
categories:
  - Blockchain
  - Fabric
tags:
